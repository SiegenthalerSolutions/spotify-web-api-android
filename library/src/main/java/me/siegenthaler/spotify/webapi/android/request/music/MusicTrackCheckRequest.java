 ...
 * (non-doc)
 */
public final class MusicTrackCheckRequest extends AbstractRequest.Builder<MusicTrackCheckRequest, List<Boolean>> {
    private final static AbstractRequest.ListType PARAMETER_TYPE = new AbstractRequest.ListType(Boolean.class);

    /**
     * (non-doc)
     */
    public MusicTrackCheckRequest() {
        super(PARAMETER_TYPE, Request.Method.GET, null);
    }

    /**
     * (non-doc)
     */
    public MusicTrackCheckRequest setIds(String... ids) {
