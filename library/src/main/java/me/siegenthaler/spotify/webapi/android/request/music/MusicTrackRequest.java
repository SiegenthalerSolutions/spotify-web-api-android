 ...
 * (non-doc)
 */
public final class MusicTrackRequest extends AbstractPageRequest<MusicTrackRequest, Track> {
    private final static AbstractRequest.PageType PARAMETER_TYPE = new AbstractRequest.PageType(Track.class);

    /**
     * (non-doc)
     */
    public MusicTrackRequest() {
        super(PARAMETER_TYPE, null);
