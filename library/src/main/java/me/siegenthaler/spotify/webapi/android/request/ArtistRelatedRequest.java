 ...
 * (non-doc)
 */
public final class ArtistRelatedRequest extends AbstractRequest.Builder<ArtistRelatedRequest, List<Artist>> {
    private final static AbstractRequest.ListType PARAMETER_TYPE = new AbstractRequest.ListType(Artist.class);

    /**
     * (non-doc)
     */
    public ArtistRelatedRequest() {
     ...
     * (non-doc)
     */
    public ArtistRelatedRequest setArtist(String id) {
