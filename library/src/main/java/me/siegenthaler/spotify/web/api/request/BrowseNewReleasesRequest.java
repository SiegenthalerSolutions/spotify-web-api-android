 ...
 * (non-doc)
 */
public final class BrowseNewReleasesRequest extends AbstractPageRequest<BrowseNewReleasesRequest, SimpleAlbum> {
    /**
     * (non-doc)
     */
    public BrowseNewReleasesRequest() {
     ...
     * (non-doc)
     */
    public BrowseNewReleasesRequest setMarket(String market) {
